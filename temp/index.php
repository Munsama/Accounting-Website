      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i> Data Jenis Transaksi</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Data Kelompok Transaksi</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Data Akun</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i> Beban</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Jurnal</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i> Laporan Perubahan Modal</a></li>
          </ul>
        </li>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>Rp20000<sup style="font-size: 20px"></sup></h3>
