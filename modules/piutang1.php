...
if(!isset($_SESSION['username'])) header ("location: login.php");
  $sql = "SELECT max(no_bukti) FROM piutang";
...
<head>
  ...
  <title>SIA Jaya Rent| Piutang</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Piutang</h3>
            </div>
          </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          ...
          <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal">Tambah Piutang</button>
                            ...
                            <div class="modal fade" id="myModal" role="dialog">
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <form action="crud.php?aksi=tambah-piutang" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                            ...
                                            <option value=""> PILIH </option>
                                            <?php
											$query	= mysqli_query($conn,"SELECT * FROM akun WHERE bagan IN ('1','4') AND kode_akun IN ('11','41') ");
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    $no = 1;
                    if($tang==1){
                    $query	= mysqli_query($conn,"SELECT * FROM piutang JOIN akun USING (kode_akun) WHERE tanggal_piutang BETWEEN '$awal' and '$akhir' ORDER BY tanggal_piutang ASC");
                    }
                    else{
                        $query	= mysqli_query($conn,"SELECT * FROM piutang JOIN akun USING (kode_akun) ORDER BY tanggal_piutang ASC");
                 ...
                 { ?>
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $hasil['tanggal_piutang'];?></td>
