...
if(isset($_GET['username'])){
  ...
  $sql = "SELECT max(no_bukti) FROM hutang";
  ...
  if ($transaksi) {
      ...
      $kode = $kode + 1;
      $auto_kode = "E" . str_pad($kode, 4, "0",  STR_PAD_LEFT);
  } else {
      $auto_kode = "E0001";
    }
...
<head>
  ...
  <title>SIA Jaya Rent| Hutang</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Hutang</h3>
            </div>
          </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          ...
          <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal">Tambah Hutang</button>
                            ...
                            <div class="modal fade" id="myModal" role="dialog">
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <form action="crud.php?aksi=tambah-hutang" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                            ...
                                            <option value=""> PILIH </option>
                                            <?php
											$query	= mysqli_query($conn,"SELECT * FROM akun WHERE bagan IN ('5') ");
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    $no = 1;
                    if($tang==1){
                    $query	= mysqli_query($conn,"SELECT * FROM hutang JOIN akun USING (kode_akun) WHERE tanggal_hutang BETWEEN '$awal' and '$akhir'ORDER BY tanggal_hutang ASC");
                    }
                    else{
                        $query	= mysqli_query($conn,"SELECT * FROM hutang JOIN akun USING (kode_akun)ORDER BY tanggal_hutang ASC");
                 ...
                 { ?>
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $hasil['tanggal_hutang'];?></td>
