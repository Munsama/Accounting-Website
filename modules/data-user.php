  ...
  <div class="content-wrapper">
    ...
    <section class="content">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="adduser" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="addpass" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label" for="">Level</label>
                                            </div>
                                            <select class="form-control" name="addlevel" required>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <th data-field="nama" data-editable="true"><center>Nama</th>
                    <th data-field="username" data-editable="true"><center>Username</th>
                    <th data-field="Email" data-editable="true"><center>Email</th>
                    <th data-field="Pass" data-editable="true"><center>Password</th>
                    <th data-field="Level" data-editable="true"><center>Level</th>
                    <th> Action </th>
                </tr>
                </thead>
                <tbody>
          ...
          <td><?php echo $hasil['password'];?></td>
                    ...
                    <td>
                        <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModals<?php echo $hasil['username'];?>"><i class="fa fa-pencil"></i>
                        </button>
                    ...
                    <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button></a>
                                    ...
                                    <div class="modal fade" id="myModals<?php echo $hasil['username'];?>" role="dialog">
                                                    <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="crud.php?aksi=edit-user" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label" for="">Nama</label>
                                                                    <input type="text" name="editnama" class="form-control" value="<?php echo $hasil['nama'];?>"  required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label" for="">Username</label>
                                                                    <input type="text" readonly ="" name="edituser" class="form-control"  value="<?php echo $hasil['username'];?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label" for="">Email</label>
                                                                    <input type="email" name="editemail" class="form-control" value="<?php echo $hasil['email'];?>" required>
                                                                </div>
                                                                
                                                                <div class="form-group">
                                                                    <input type="text" name="editpass" class="form-control" value="<?php echo $hasil['password'];?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="control-label" for="">Level</label>
                                                                </div>
                                                                <select class="form-control" name="editlevel">
