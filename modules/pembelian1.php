...
if(isset($_GET['username'])){
  ...
  $sql = "SELECT max(no_bukti) FROM pembelian";
  ...
  if ($transaksi) {
      ...
      $kode = $kode + 1;
      $auto_kode = "C" . str_pad($kode, 4, "0",  STR_PAD_LEFT);
  } else {
      $auto_kode = "C0001";
  }
...
<head>
  ...
  <title>SIA Jaya Rent| Pembelian</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          ...
          <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal">Tambah Pembelian</button>
                            ...
                            <div class="modal fade" id="myModal" role="dialog">
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <form action="crud.php?aksi=tambah-pembelian" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div class="modal-body">
                                            ...
                                            <?php
											$query	= mysqli_query($conn,"SELECT * FROM akun WHERE bagan IN ('1') AND kode_akun NOT IN ('11','14','15')");
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    $no = 1;
                    if($tang==1){
                    $query	= mysqli_query($conn,"SELECT * FROM pembelian JOIN akun USING (kode_akun) WHERE tanggal_pembelian BETWEEN '$awal' and '$akhir' ORDER BY tanggal_pembelian ASC");
                    }
                    else{
                        $query	= mysqli_query($conn,"SELECT * FROM pembelian JOIN akun USING (kode_akun) ORDER BY tanggal_pembelian ASC");
