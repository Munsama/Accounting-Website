...
if(!isset($_SESSION['username'])) header ("location: login.php");
  ...
  $sql = "SELECT max(no_bukti) FROM prive";
...
<head>
  ...
  <title>SIA Jaya Rent| Prive</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Prive</h3>
            </div>
          </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          ...
          <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal">Tambah prive</button>
                              ...
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Tambah Prive</h4>
                                  </div>
                                  
                                  <form action="crud.php?aksi=tambah-prive" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div class="modal-body">
                                            ...
                                            <?php
											$query	= mysqli_query($conn,"SELECT * FROM akun WHERE nama_akun= 'prive' ");
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                    $no = 1;
                    if($tang==1){
                    $query	= mysqli_query($conn,"SELECT * FROM prive JOIN akun USING (kode_akun) WHERE tanggal_prive BETWEEN '$awal' and '$akhir' ORDER BY tanggal_prive ASC");
                    }
                    else{
                        $query	= mysqli_query($conn,"SELECT * FROM prive JOIN akun USING (kode_akun) ORDER BY tanggal_prive ASC");
                 ...
                 { ?>
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $hasil['tanggal_prive'];?></td>
