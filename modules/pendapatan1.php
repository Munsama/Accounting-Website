...
if(isset($_GET['username'])){
  ...
  $sql = "SELECT max(no_bukti) FROM pendapatan";
...
<head>
  ...
  <title>SIA Jaya Rent| Pendapatan</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabel Pendapatan</h3>
            </div>
          </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          ...
          <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#myModal">Tambah Pendapatan</button>
          ...
          <!-- Modal -->
                            <div class="modal fade" id="myModal" role="dialog">
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <form action="crud.php?aksi=tambah-pendapatan" method="POST" enctype="multipart/form-data">
                                  ...
                                  <div class="modal-body">
                                            ...
                                            <select class="form-control" name="addakun" value ="PILIH"placeholder = "PILIH" required>
                                            <option value=""> PILIH </option>
                                            <?php
											$query	= mysqli_query($conn,"SELECT * FROM akun WHERE bagan IN ('3', '4')");
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                    <th align = "center" data-field="no" data-editable="true"><center>No</th>
                    <th align = "center" data-field="tgl" data-editable="true"><center>Tanggal</th>
                    <th align = "center" ata-field="bkt" data-editable="true"><center>No Bukti</th>
                    <th align = "center" data-field="kt" data-editable="true"><center>Keterangan</th>
                    <th align = "center" data-field="akun" data-editable="true"><center>Akun</th>
                    <th align = "center" data-field="nominal" data-editable="true"><center>Nominal</th>
                ...
                <?php
                    $no = 1;
                    if($tang==1){
                    $query	= mysqli_query($conn,"SELECT * FROM pendapatan JOIN akun USING (kode_akun) WHERE tanggal_pendapatan BETWEEN '$awal' and '$akhir' ORDER BY tanggal_pendapatan ASC");
                    }
                    else{
                        $query	= mysqli_query($conn,"SELECT * FROM pendapatan JOIN akun USING (kode_akun) ORDER BY tanggal_pendapatan ASC");
                 ...
                 { ?>
                  <tr>
                    <td><?php echo $no++; ?></td>
                    <td><?php echo $hasil['tanggal_pendapatan'];?></td>
