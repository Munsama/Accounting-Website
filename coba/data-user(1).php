                                  ...
                                  <div class="modal-body">
										<form action="admin_proses.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="txtnama" class="form-control" id="" value="<?php echo $result_edit['Nama'];?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label" for="">Email</label>
                                                <input type="text" name="txtemail" class="form-control" id=""  value="<?php echo $result_edit['Email'];?>" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label" for="">Username</label>
                                                <input type="text" name="txtuser" class="form-control"  value="<?php echo $result_edit['Username'];?>" id="" required>
                                            </div>
                                            <div class="form-group">
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">									
                                        <thead>
                                            <tr>
                                                <th data-field="email" data-editable="true">No</th>
										...
										<?php
											...
											$query	= mysqli_query($conn,"SELECT * FROM user");
												...
												{ ?>
                                                    ...
                                                    <td><a href="data-user-tambah.php?status=edit&username=<?php echo $hasil['Username'];?>"> 
