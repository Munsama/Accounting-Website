...
switch($status) {
	...
	case 'edit':
		$edit	= "UPDATE user SET nama='$nama',username='$user', email='$emai',password='$pass', level='$level'";
	...
	default:
	$id =$_GET['usernames'];
	$tambah	= mysql_query ("DELETE FROM user WHERE username ='$id'")or die (mysql_error());
		if ($tambah=true){
